    ...
    >
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder text-white mb-0">{{ $route.meta.title }}</h6>
            </nav>
...
//     computed: {
//         isVirtualReality() {
//             // Replace with your actual logic for checking the route
//             return this.$route && this.$route.path.includes("virtual-reality");
//         },
//     },
//     methods: {
//         logout() {
//             // Implement your logout logic here, e.g., call API and redirect
//             // Example:
